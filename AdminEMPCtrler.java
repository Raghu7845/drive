...
/**
 * Servlet implementation class AdminEMPCtrler
 */
@WebServlet("/AdminEMPCtrler")
public class AdminEMPCtrler extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminEMPCtrler() {
        super();
