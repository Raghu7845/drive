                            ...
                            <div class="box box-primary">
                               ...
                               <%! String gender="MALE"; %>
                                    ...
                                    <%if (request.getAttribute("status").equals("ACTIVE")){ %>
                                    	...
                                    	<a href="InactiveCtrler?type=admin&id=${usm.userId}" class="btn btn-danger btn-block"><span class="glyphicon glyphicon-edit"></span>INACTIVATE</a>
                                	<%}else{ %>
                                		<li class="list-group-item">
                                            <span class="fa fa-phone margin-r-5"></span> <b> Status</b> <label class="label label-danger pull-right">INACTIVE</label>
                                        </li>
                                    	<a href="InactiveCtrler?type=admin&id=${usm.userId}" class="btn btn-success btn-block"><span class="glyphicon glyphicon-edit"></span>ACTIVATE</a>
                                	<%} %>
                                    </ul>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
                            ...
                            <div class="box box-warning">
								...
								<input name="basic_pay" type="number" onblur="calc()" class="form-control validate[required] text-input" value="${usm.basicPay}"/>
                                                ...
                                                <tr class="form-group">
                                                        ...
                                                        <td>
                                                            <div class="form-input col-md-6">								
								<input name="hra" disabled="disabled" type="number" class="form-control validate[required] text-input" value="${usm.hra}"/>
                                                            </div>
                                                        </td>
                                                </tr>
                                                <tr class="form-group">
                                                        ...
                                                        <td>
                                                            <div class="form-input col-md-6">								
								<input name="da" disabled="disabled" type="number" class="form-control validate[required] text-input" value="${usm.da}"/>
                                                            </div>
                                                        </td>
                                                </tr>
                                                <tr class="form-group">
                                                        ...
                                                        <td>
                                                            <div class="form-input col-md-6">								
								<input name="gpf" type="number" disabled="disabled" class="form-control validate[required] text-input" value="${usm.gpf}"/>
                                                            </div>
                                                        </td>
                                                </tr>
                                                <tr class="form-group">
                                                        ...
                                                        <td>
                                                            <div class="form-input col-md-6">								
								<input name="it" type="number" disabled="disabled" class="form-control validate[required] text-input" value="${usm.IT}"/>
                                                            </div>
                                                        </td>
                                                </tr>
                                                <tr class="form-group">
								...
								<input name="misc" type="number" onblur="calc()" class="form-control validate[required] text-input" value="${usm.miscAllowance}"/>
                                                ...
                                                <tr class="form-group">
                                                        ...
                                                        <td>
                                                            <div class="form-input col-md-6">								
								<input name="cgps" type="number" disabled="disabled" class="form-control validate[required] text-input" value="${usm.cghs}"/>
                                                            </div>
                                                        </td>
                                                </tr>
                                                <tr class="form-group">
                                                        ...
                                                        <td>
                                                            <div class="form-input col-md-6">								
								<input name="bonus" type="number" disabled="disabled" class="form-control validate[required] text-input" value="${usm.bonus}"/>
                                                            </div>
                                                        </td>
                                                </tr>
                                                <tr class="form-group">
                                                        ...
                                                        <td>
                                                            <div class="form-input col-md-6">								
								<input name="net_sal" type="number" disabled="disabled" class="form-control validate[required] text-input" value="${usm.netSalary}"/>
                                                            </div>
                                                        </td>
                                                </tr>
                                            </thead>
		    		            ...
		    		            $.ajax({
		    		                 ...
		    		                 success: function(response) {
		    		                      ...
		    		                      if(data.status=="SUCCESS"){
		    			                		...
		    			                		window.location.href ='UserViewCtrler?type=admin&user_id='+${usm.userId};
